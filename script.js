...
class DeliveryAreaSystem {
    ...
    saveNeighborhood() {
        if (this.selectedNeighborhood) {
            localStorage.setItem('selectedNeighborhood', JSON.stringify({
    ...
    loadSavedNeighborhood() {
        ...
        if (saved) {
            try {
                ...
                this.selectedNeighborhood = data.neighborhood;
                this.deliveryFee = data.deliveryFee;
                
                // If we have a saved neighborhood, skip welcome screen
                this.proceedToMenu();
            } catch (error) {
                console.error('Error loading saved neighborhood:', error);
